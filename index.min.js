!(function(e, t) {
    ...
    function l(e, t, r) {
        ...
        (o.displayName = a),
        i)
        return D(s, t), (s.wrappedComponent = t), Object.defineProperties(s, G), s
    }
    function f(e) {
        return function(t, n) {
            return (
    ...
    function d() {
        ...
        if ("function" == typeof arguments[0])
            return (
                ...
                function(t) {
                    var n = l(e, t)
                    return (n.isMobxInjector = !1), (n = O(n)), (n.isMobxInjector = !0), n
                }
            )
    ...
    function O(e, t) {
        ...
        return g(r.prototype || r), (r.isMobXReactObserver = !0), r
    }
    function g(e) {
    ...
    var x =
        ...
        X = Object.freeze({
            ...
            arrayOrObservableArrayOf: q,
            objectOrObservableObject: B
        }),
        H = { mobxStores: B }
    Object.seal(H)
    var G = {
        ...
        Q = {
                ...
                if (!0 !== V) {
                    ...
                    var c = this.render.bind(this),
                        ...
                        l = function() {
                            ...
                            if (
                                (u.track(function() {
                                    K && (r.__$mobRenderStart = Date.now())
                                    try {
                                        n = t.extras.allowStateChanges(!1, c)
                                    } catch (t) {
                                        e = t
                                    }
                                    K && (r.__$mobRenderEnd = Date.now())
                                }),
                                e)
                            )
                                throw (J.emit(e), e)
            ...
            componentWillUnmount: function() {
                if (
                    ...
                    var e = y(this)
                    e && z && z.delete(e), Y.emit({ event: "destroy", component: this, node: e })
                }
            },
    ...
    var ee,
        ...
        (ee.contextTypes = { mobxStores: B }),
        (ee.childContextTypes = { mobxStores: B.isRequired }),
        te)
    ...
    if (
        ...
        ("undefined" == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__
            ? "undefined"
            : x(__MOBX_DEVTOOLS_GLOBAL_HOOK__))
    ) {
        var oe = { spy: t.spy, extras: t.extras },
            ie = { renderReporter: Y, componentByNodeRegistery: z, trackComponents: h }
